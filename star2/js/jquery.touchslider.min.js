		...
		var switching = (function() {
			...
			return {
				...
				to: function(toIndex, opt) {
					...
					if (toIndex+1==slides.length) {
						$(options.next, container).addClass('hide');
					}else{
						$(options.next, container).removeClass('hide');
					}
					if (toIndex==0) {
						$(options.prev, container).addClass('hide');
					}else{
						$(options.prev, container).removeClass('hide');
					}
